...
import { OpportunityOfDay } from '@/lib/api';
    ...
    <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800 p-6 text-white shadow-lg transition-all duration-300 hover:shadow-xl">
      ...
      <div className="relative z-10">
        ...
        <p className="text-indigo-200 mb-6">
          Primary keyword: <span className="font-semibold text-white">{opportunity?.primary_keyword || 'N/A'}</span>
        ...
        <div className="rounded-xl bg-white/10 backdrop-blur-sm p-4">
          <p className="text-sm text-indigo-100">{opportunity?.recommendation || 'No recommendation available'}</p>
        </div>
